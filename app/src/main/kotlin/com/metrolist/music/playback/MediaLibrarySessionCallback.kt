        ...
        return MediaItem.Builder()
            ...
            .setMediaMetadata(
                MediaMetadata.Builder()
                    ...
                    .setArtworkUri(thumbnail?.toUri()?.let { AlbumArtContentProvider.mapUri(it, size = 544) })
                    .setIsPlayable(true)
        ...
        return MediaItem.Builder()
            ...
            .setMediaMetadata(
                MediaMetadata.Builder()
                    ...
                    .setArtist(subtitle)
                    .setArtworkUri(artworkUrl?.toUri()?.let { AlbumArtContentProvider.mapUri(it, size = 544) })
                    .setIsPlayable(false)
                    .setIsBrowsable(true)
                ...
                MusicService.ARTIST -> {
                    ...
                    artistList.map { artist ->
                        ...
                        val artworkUri = artist.thumbnail?.let { url ->
                            ...
                            hiRes.toUri()
                        }?.let { AlbumArtContentProvider.mapUriCrop(it, size = 544) }
                        ...
                        allSections.forEach { section ->
                            ...
                            val folder = MediaItem.Builder()
                                ...
                                .setMediaMetadata(
                                    MediaMetadata.Builder()
                                        .setTitle(title)
                                        .setArtworkUri(firstThumb?.toUri()?.let { AlbumArtContentProvider.mapUri(it, size = 544) })
                                        .setIsPlayable(false)
                                        .setIsBrowsable(true)
                                        .setMediaType(MediaMetadata.MEDIA_TYPE_FOLDER_MIXED)
                                        ...
                                        is SongItem -> MediaItem.Builder()
                                            ...
                                            .setMediaMetadata(
                                                MediaMetadata.Builder()
                                                    ...
                                                    .setArtworkUri(ytItem.thumbnail?.toUri()?.let { AlbumArtContentProvider.mapUri(it, size = 544) })
                                                    .setIsPlayable(true)
                                                    .setIsBrowsable(false)
                                                    .setMediaType(MediaMetadata.MEDIA_TYPE_MUSIC)
                                                    .build()
                        ...
                        MediaItem.Builder()
                            ...
                            .setMediaMetadata(
                                MediaMetadata.Builder()
                                    ...
                                    .setArtworkUri(itemThumbnail?.toUri()?.let { AlbumArtContentProvider.mapUri(it, size = 544) })
        ...
        return MediaItem
            ...
            .setMediaMetadata(
                MediaMetadata
                    ...
                    .setSubtitle(artists.joinToString { it.name })
                    .setArtist(artists.joinToString { it.name })
                    .setArtworkUri(song.thumbnailUrl?.toUri()?.let { AlbumArtContentProvider.mapUri(it, size = 544) })
                    .setIsPlayable(isPlayable)
                    .setIsBrowsable(isBrowsable)
                    .setMediaType(MediaMetadata.MEDIA_TYPE_MUSIC)
                    .build(),
