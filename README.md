...
* **플레이리스트** — YouTube 라이브러리에 저장한 플레이리스트 표시
* **음질 설정** — 자동/낮음/높음/매우 높음 선택
* **음량 부스트** — 0~30 dB 게인 조절 (차량 스피커 대응)
...
> **참고:** 로그인 시 비밀번호가 입력되지 않는 문제가 있습니다 (폴스타 자체 버그로 추정). 이 경우 비밀번호 입력칸 바로 아래의 **"비밀번호 표시" 체크박스를 누른 뒤** 입력하면 정상적으로 입력됩니다.
...
자세한 내용은 [LICENSE](https://github.com/dozyco/PTubeMusic/blob/automotive/LICENSE) 파일을 참고하세요.
